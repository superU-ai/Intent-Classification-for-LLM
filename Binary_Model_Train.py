...
data = final_df[final_df["intent"].isin(["information", "emotion support", "brand exploration", "navigation", "support", "faq", "purchase intent"])]
data['binary'] = "user query"
data.loc[data['intent'].isin(["navigation", "purchase intent", "brand exploration"]), 'binary'] = "purchase intent"
data = data[["question", "binary"]]
data.columns = ["question", "intent"]
